...
$config['db']['master']['username'] = 'w7_pplu_site';
$config['db']['master']['password'] = '7xk3TsErELKCA3ce';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'w7_pplu_site';
...
$config['setting']['authkey'] = 'e00bcd84';
